...
#ifdef AUDIO_ENABLE
  virtual unsigned parse(struct timeval presentationTime);
#else
...
#ifdef AUDIO_ENABLE
unsigned H264or5VideoStreamParser::parse(struct timeval presentationTime) {
#else
...
#ifdef AUDIO_ENABLE
    if(presentationTime.tv_sec == 0 && presentationTime.tv_sec == 0) {
    } else {
      usingSource()->fPresentationTime = presentationTime;
    }
#else
...
//    if(presentationTime.tv_sec == 0 && presentationTime.tv_sec == 0) {
//    } else {
//      usingSource()->fNextPresentationTime = presentationTime;
//    }
#else
